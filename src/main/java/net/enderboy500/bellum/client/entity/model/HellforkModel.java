...
public class HellforkModel extends Model<Unit> {
    public static final Identifier TEXTURE = Bellum.id("textures/entity/hellfork.png");

    public HellforkModel(ModelPart modelPart) {
