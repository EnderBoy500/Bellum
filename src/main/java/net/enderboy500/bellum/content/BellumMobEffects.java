...
import io.github.ciph3rj.cipherlib.effect.BasicStatusEffect;
...
public class BellumMobEffects {
    ...
    public static final Holder<MobEffect> STUN = RegistryHelper.registerEffect("stun", new BasicStatusEffect(MobEffectCategory.NEUTRAL, 0xFFE266));
